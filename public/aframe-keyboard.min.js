    ...
    AFRAME.registerComponent("keyboard-button", {
        init: function() {
            ...
            e.addEventListener("mousedown", function() {
                ...
                e.setAttribute("material", "opacity", "0.9"), t.isMouseEnter = !0
            }), e.addEventListener("mouseleave", function() {
                e.setAttribute("material", "opacity", "0"), t.isMouseEnter = !1
            })
        }
    })
}, function(e, t, a) {
        ...
        drawKeyboard() {
            ...
            if (this.keyboardKeys) {
                const e = this.keyboardKeys[this.activeMode] || this.keyboardKeys.normal,
                    ...
                    a = 11 * s + 10 * r + 2 * n,
                    d = s * e.length + r * (e.length - 1) + 2 * n;
                t.setAttribute("position", `${a/2-n} ${-d/2+n} -0.01`), t.setAttribute("geometry", `primitive: plane; width: ${a}; height: ${d}`), this.baseTexture && this.baseTexture.length > 0 ? t.setAttribute("material", `src: ${this.baseTexture}`) : t.setAttribute("material", "color: #4a4a4a; side: double; opacity: 0.7"), this.el.appendChild(t);
                let l = 0;
                for (let t = 0; t < e.length; t++) {
                    ...
                    for (let e = 0; e < a.length; e++) {
                        const t = a[e],
                            n = this.parseKeyObjects(t);
                        if (!this.dismissable && "cancel" === t.type) continue;
                        const u = n.size.split(" ")[0],
                            i = n.size.split(" ")[1];
                        this.drawButton({
                            key: n,
                            position: `${d+u/2} ${l-i/2} 0`
                        }), d += parseFloat(u) + r, a.length === e + 1 && (l -= s + r)
                    }
                }
            }
        }
